...
namespace ATNET.Services.PrintService
{
    ...
    public class XpsPrintHelper
    {
        ...
        public XpsPrintHelper(Visual visual)
        {
            printVisual = visual;
        }
        ...
        public void PrintVisualAsync(PrintQueue pq)
        {
            XpsDocumentWriter xdwPrint = GetPrintXpsDocumentWriter(pq);
            PrintVisualAsync(xdwPrint, printVisual);
        }
